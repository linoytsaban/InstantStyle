...
class SemanticStableDiffusionXLPipeline(DiffusionPipeline, FromSingleFileMixin, LoraLoaderMixin):
    r"""
    ...
    def encode_prompt(
        ...
        if prompt is not None and isinstance(prompt, str):
            ...
            print("HELLLLOOOOO", prompt_embeds.shape[0])
        ...
        if enable_edit_guidance and edit_concepts_embeds is None:
            ...
            for editing_prompt, tokenizer, text_encoder in zip(editing_prompts, tokenizers, text_encoders):
                ...
                max_length = prompt_embeds.shape[1]
                print("HELLLLOOOOO2222", max_length)
                ...
                print("HELLLLOOOOO333", edit_concepts_input_ids.shape)
    ...
    def __call__(
        ...
        if editing_prompt:
            ...
            print("SHALOMMMMM", editing_prompt_embeddings)
        else:
        ...
        print(editing_prompt_embeddings.shape)
        ...
        (
            ...
            editing_prompt=editing_prompt,
            edit_concepts_embeds=editing_prompt_embeddings,
            edit_pooled_prompt_embeds=editing_pooled_prompt_embeds,
        )
        ...
        if enable_edit_guidance:
            print(negative_prompt_embeds.shape)
            print(prompt_embeds.shape)
            print(edit_prompt_embeds.shape)
